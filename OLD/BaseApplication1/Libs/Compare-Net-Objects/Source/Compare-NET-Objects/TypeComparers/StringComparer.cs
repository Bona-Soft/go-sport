...
namespace KellermanSoftware.CompareNetObjects.TypeComparers
{
    ...
    public class StringComparer : BaseTypeComparer
    {
        ...
        public override void CompareType(ComparisonResult result, object object1, object object2, string breadCrumb)
        {
            ...
            if (result.Config.TrimStringToCompare)
            {
                areDifferents = valOne != null && (object1.ToString().Trim().CompareTo(object2.ToString().Trim()) != 0);
            }
            else
            {
                areDifferents = valOne != null && valOne.CompareTo(object2) != 0;
            }
